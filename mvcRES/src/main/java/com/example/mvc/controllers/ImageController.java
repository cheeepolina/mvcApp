...
import com.example.mvc.repositories.ImageRepository;
...
public class ImageController {
    ...
    private ResponseEntity<?> getImageById(@PathVariable Long id) {
        //поиск изображения
        Image image = imageRepository.findById(id).orElse(null);//находим картинку по id и присваеваем image  если не найдено то возвращаем null
    ...
    }//тело ответа которое представляет собой поток InputStreamResource из массива байтов изображения image.getBytes()
}
